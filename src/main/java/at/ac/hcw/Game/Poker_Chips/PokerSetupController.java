...
// Für Tim: Controller für Setup-UI
...
public class PokerSetupController {
    ...
    // Linke und rechte Spalte im Setup-Layout:
    // Spieler 1-3 links, Spieler 4-6 rechts
    @FXML
    private VBox leftColumn;
    @FXML
    private VBox rightColumn;

    // Blind-Eingabefelder aus dem FXML
    @FXML
    private TextField bigBlindField;
    @FXML
    private TextField smallBlindField;

    // Liste aller "PlayerCard" UI-Elemente (dynamisch erzeugt)
    // Jede PlayerCard enthält Name + Chips Input für einen Spieler
    private final List<PlayerCard> playerCards = new ArrayList<>();

    /*
     * initialize() wird automatisch aufgerufen, wenn das FXML geladen wurde.
     * Hier wird das Setup initial befüllt: standardmäßig 2 Spieler.
     */
    @FXML
    ...
    private void handleGoToSettings() throws IOException {
        ...
        // Kennzeichen, dass wir nicht aus Blackjack kommen
